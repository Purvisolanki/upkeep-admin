...
import landlordConfigHome from '../main/landlord role/landlordConfigHome';
...
const routeConfigs = [AdminRepairerConfig,adminPropertyConfig,adminTenantConfig,adminLandlordConfig,landlordConfigHome,profileConfig,tenantConfig,homeConfig,ExampleConfig, SignOutConfig, SignInConfig, SignUpConfig,PropertyConfig,landlordConfig];

const routes = [
  ...FuseUtils.generateRoutesFromConfigs(routeConfigs, settingsConfig.defaultAuth),
  {
    path: '/',
    element: <Navigate to="/adminlandlord" />,
