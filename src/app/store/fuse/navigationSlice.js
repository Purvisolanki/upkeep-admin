...
import { getNavigationConfig } from "../../utils/User";
...
const initialState = navigationAdapter.upsertMany(
  emptyInitialState,
  getNavigationConfig(localStorage.getItem("user_role"))
);
// const initialState = navigationAdapter.upsertMany(emptyInitialState, () => {
//   const navigationConfig = getNavigationConfig(localStorage.getItem("user_role"));
//   return navigationConfig !== null ? navigationConfig : {};
// });
